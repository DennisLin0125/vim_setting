...
hash git >/dev/null && /usr/bin/env git clone https://github.com/DennisLin0125/vim_setting.git ~/.vim || {
...
echo "\033[0;34mGithub Repository: https://github.com/DennisLin0125/vim_setting\033[0m"
echo "\033[0;34mfeel free to fork it :)\033[0m"
echo "\033[0;34m<DennisLin> "
echo ""
